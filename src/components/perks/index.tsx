    ...
    <div className="flex flex-col items-center justify-center  w-full">
      <Container>
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl bg-gradient-to-r from-brand-300 to-[#b5179e] text-transparent bg-clip-text font-heading font-medium !leading-snug mt-6">
            Discover the benefits
          </h2>
          <p className="text-base md:text-lg text-center text-[#4cc9f0] mt-6">
            Explore the powerful features and advantages that Ping Pilot offer
