...
function HoverShine({ text, className, loading }: ShinyButtonProps) {
  return (
    <button
      id="hover-shine"
      className={cn(
        "group cursor-pointer relative  w-[120px] h-[60px] bg-[linear-gradient(144deg,_#af40ff,_#5b42f3_50%,_#00ddeb)] text-white whitespace-nowrap flex flex-wrap rounded-lg overflow-hidden transition-all duration-300",
        className
      )}
    >
      {loading ? (
