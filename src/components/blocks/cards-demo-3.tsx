...
export default function CardDemo() {
  return (
    <Card>
      ...
      <CardDescription>
        Get notified about Critical Events the moment they happen no matter if
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        <Container className="h-8 w-8 circle-1">
          <Icons.discord2 className="h-4 w-4" />
        </Container>
        ...
        <Container className="circle-3">
          ...
          <Image src={RocketIcon} alt="Rocket Icon" className="size-8" />
        </Container>
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        " w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-900 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
...
export const CardTitle = ({
  ...
  return (
    <h3
      className={cn(
        "text-lg font-semibold text-white dark:text-white py-2",
        className
      )}
    >
      {children}
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "text-sm font-normal text-neutral-400 dark:text-neutral-400 max-w-sm",
        className
      )}
    >
      {children}
