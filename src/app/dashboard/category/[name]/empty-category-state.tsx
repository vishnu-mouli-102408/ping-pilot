...
export const EmptyCategoryState = ({
  ...
  const codeSnippet = `await fetch('https://pingpilot.vishnumouli.me/api/v1/event', {
  method: 'POST',
  headers: {
  ...
  return (
    ...
    >
      <h2 className="text-xl/8 font-medium text-center tracking-tight text-gray-100">
        Create your first {categoryName} event
      </h2>
      <p className="text-sm/6 text-[#ced4da] mb-8 max-w-md text-center text-pretty">
        Get started by sending a request to our tracking API:
      </p>

      <div className="w-full max-w-3xl rounded-lg shadow-lg overflow-hidden">
        <div className="bg-[#000814] px-4 py-2 flex justify-between items-center">
      ...
      <div className="mt-8 flex flex-col items-center space-x-2">
        ...
        <p className="text-sm/6 text-[#f8f9fa] mt-2">
